    ...
    public partial class MainWindow : Window
    {
        ...
        private void InitializeBackgroundImage()
        {
            try
            {
                ...
                bgImage.Source = new BitmapImage(new Uri("pack://application:,,,/Resources/background.jpg"));
                bgImage.Stretch = Stretch.UniformToFill;

                var bgBorder = new Border();
                bgBorder.Child = bgImage;
                bgBorder.RenderTransform = new ScaleTransform(1.05, 1.05);

                MainGrid.Children.Insert(0, bgBorder);
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Ошибка инициализации фонового изображения");
            }
        }
        ...
        private void InitializeContentGrid()
        {
            ...
            contentGrid.RenderTransform = new ScaleTransform(0.9, 0.9);
