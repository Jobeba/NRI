...
namespace NRI
{
    public partial class MainWindow : Window
    {
...

        {
            ...
            // Инициализация трансформаций контента
            var contentTransform = ContentGrid.RenderTransform;
            ...
            if (_contentScale == null)
            {
                ...
                ContentGrid.RenderTransform = new TransformGroup
                {
                    Children = new TransformCollection { _contentScale }
                };
                contentTransformGroup = ContentGrid.RenderTransform as TransformGroup;
            }
            ...
            _toggleIcon = ToggleFullscreenButton?.FindName("ToggleIcon") as PackIcon;
        ...
        private async Task ExpandMenuAsync()
        {
            if (_contentScale == null)
            {
                _contentScale = new ScaleTransform(0.9, 0.9);
                ContentGrid.RenderTransform = new TransformGroup
                {
                    Children = new TransformCollection { _contentScale }
                };
            ...
            ContentGrid.Opacity = 0; // Начинаем с прозрачного

            var opacityAnim = new DoubleAnimation(1, _animationDuration);
            var scaleAnim = new DoubleAnimation(1, _animationDuration);

            ContentGrid.BeginAnimation(OpacityProperty, opacityAnim);
            _contentScale.BeginAnimation(ScaleTransform.ScaleXProperty, scaleAnim);
            _contentScale.BeginAnimation(ScaleTransform.ScaleYProperty, scaleAnim);
            ...
            try
            {
                ...
                switch (highestRole)
                {
                    ...
                    case "Организатор":
                        ...
                        break;
                    default: // "Игрок" и любые другие случаи
        ...
        {
            var currentControl = MainFrame.Content as BaseWindowControl;
            currentControl?.ToggleMenu(true);
        }
        ...
        private void NavigateToReviews(object sender, RoutedEventArgs e)
        {
