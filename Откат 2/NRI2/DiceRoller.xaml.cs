...
namespace NRI
{
    public partial class DiceRoller : Window
    {
        ...
        private const int AnimationDurationMs = 500; // Длительность анимации в миллисекундах
        ...
        private void Showdown_Click(object sender, RoutedEventArgs e) => Application.Current.Shutdown();
